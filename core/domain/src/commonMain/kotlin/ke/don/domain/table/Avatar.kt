...
enum class Avatar {
    ...
    fun url(): String {
        return when (this) {
            ...
            Avery -> "https://api.dicebear.com/9.x/adventurer/svg?seed=Avery"
            ...
            Maria -> "https://api.dicebear.com/9.x/adventurer/svg?seed=Maria"
            ...
            Sarah -> "https://api.dicebear.com/9.x/adventurer/svg?seed=Sarah"
