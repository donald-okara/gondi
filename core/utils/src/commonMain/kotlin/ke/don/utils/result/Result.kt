...
sealed interface Result<out D, out E : Error> {
    ...
    data class Error<out E : ke.don.utils.result.Error>(val error: E) : Result<Nothing, E>

    companion object {
        fun <D> success(data: D): Result<D, Nothing> = Success(data)
        fun <E : ke.don.utils.result.Error> error(error: E): Result<Nothing, E> = Error(error)
    }
}
